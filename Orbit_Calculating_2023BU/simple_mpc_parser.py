#!/usr/bin/env python3
"""
Simple and robust MPC data parser for asteroid 2023 BU
"""
...
def parse_mpc_line(line):
    """
    Parse MPC observation line with multiple pattern matching
    """
    line = line.strip()
...
def main():
    print("=== Simple MPC Parser for 2023 BU ===")
    print("Parsing observation data...")
    
    # Real data from the provided URL
    real_data = """K23B00U  C2023 01 21.34299109 50 04.192+43 47 13.29         21.19RU~6CJqI41
...
K23B00U KC2023 01 23.99738609 45 14.743+43 11 49.49 19.4 GV~6CJqJ95"""
    ...
    for i, line in enumerate(lines):
        ...
        if obs_line:
            ...
            print(f"  Line {i+1}: {obs_line}")
    
    if observations:
        print(f"\nSuccessfully parsed {len(observations)} observations")
