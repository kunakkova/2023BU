#include "Ephemeris.h"
#include "simple_observationProcessor.h"
...
int main()
{
    std::cout << "=== Asteroid 2023 BU Orbit Calculation (Simple Version) ===" << std::endl;
    std::cout << "Calculating orbit from real observations" << std::endl;
    std::cout << "Note: This version does NOT include gravitational acceleration" << std::endl;
    std::cout << std::endl;

    // Initialize observation processor
    SimpleObservationProcessor processor;
    ...
    std::cout << "Found " << processor.observations.size() << " observations" << std::endl;
